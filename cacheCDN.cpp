...
ICS45C::CDN::Cache::Cache(unsigned int freshnessCount) {
...
std::string ICS45C::CDN::Cache::getText(std::string filepath) {
...
char* ICS45C::CDN::Cache::getBinary(std::string filepath) {
...
// saved file
bool ICS45C::CDN::Cache::isCached(std::string filepath) {
  TextFile* current = textfiles;
...
unsigned int ICS45C::CDN::Cache::getFreshness(std::string filepath) {
...
void ICS45C::CDN::Cache::markFileFresh(std::string filepath) {
  TextFile* current = textfiles;
...
void ICS45C::CDN::Cache::purgeCache() {
  // delete all the files
  while (textfiles != nullptr) {
    TextFile* next = textfiles->next;
    delete textfiles;
...
std::string ICS45C::CDN::Cache::topFile() {
...
std::string ICS45C::CDN::Cache::getStats() {
